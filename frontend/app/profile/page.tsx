...
export default function ProfilePage() {
  ...
  if (!profile) {
    return (
      <div style={{ padding: "4rem", textAlign: "center", color: "var(--mocha)" }}>
        Loading…
      </div>
    );
  }
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                  ...
                  {ALL_PREFS.map(p => (
                    <button
                      ...
                      style={{
                        ...
                        background: prefs.includes(p)
                          ? "var(--terracotta)"
                          : "transparent",
                        color: prefs.includes(p) ? "white" : "var(--mocha)",
                        border: `1.5px solid ${
                          prefs.includes(p) ? "var(--terracotta)" : "var(--border)"
                        }`,
                      }}
                    >
                      {p}
              ...
              <button
                ...
                disabled={saving}
                style={{ padding: "0.75rem", opacity: saving ? 0.7 : 1 }}
              >
